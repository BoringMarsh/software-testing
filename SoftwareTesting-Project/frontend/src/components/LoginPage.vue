<template>
  ...
  <el-dialog v-model="dialogVisible" title="选择角色" width="30%" draggable>
    <el-radio-group v-model="selectedRegRole">
      <el-radio label="student">我是学生</el-radio>
      <el-radio label="admin">我是社团管理员</el-radio>
    </el-radio-group>
    <template #footer>
      <span class="dialog-footer">
        <el-button @click="dialogVisible = false">取消</el-button>
        <el-button type="danger" @click="handleRoleSelection">
          确定
        </el-button>
      </span>
    </template>
...
.total-layout {
  background-image: url('../assets/login.jpg'); /* Replace with your image path  register.jpg */
